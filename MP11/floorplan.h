...
int is_leaf_node(node_t*);                                  // Check if is a leave node.
...
int get_total_resource(node_t* ptr);                        // Get total resource number used by the design.
...
node_t* init_node(node_t*, module_t*, cutline_t);
